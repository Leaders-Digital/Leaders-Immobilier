                ...
                <div className="ltn__product-slider-area ltn__product-gutter pb-20 plr--7">
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="section-title-area ltn__section-title-2--- text-center">
                                    <h6 className="section-subtitle section-subtitle-2 ltn__secondary-color  mt-30">NOUVEAUTÉS</h6>
                                    ...
                                    <div className="ltn__product-item ltn__product-item-4 text-center---">
                                        <div className="product-img go-top">
                                            ...
                                            <div className="product-badge">
                                                <ul>
                                                    <li className={`sale-badge ${product.badge === 'For Rent' ? 'bg-green' : 'bg-green---'}`}>{product.badge}</li>
                                                </ul>
                                            </div>
						...
						<div className="text-center mt-4">
                            <Link to="/vente" className="btn btn-primary voir" >
                                Voir Plus
                            </Link>
                        </div>
                    </div>
